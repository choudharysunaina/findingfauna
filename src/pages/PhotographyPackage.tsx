...
const GA_CATEGORY = "pkg_photography";
...
const tourDays: TourDay[] = [
  {
    ...
    description:
      "Your wild journey begins with a warm welcome in Gwalior, followed by a comfortable road transfer to Pohari, the gateway to Kuno.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="space-y-8">
              <div className="space-y-6 pt-4">
                ...
                >
                  Capture India’s cheetahs, leopards, tigers, and the elusive
                  gharials on this 3 Nights / 4 Days photography tour. Explore
                  Kuno National Park, Palighat Gharial Sanctuary, and Madhav
                  Tiger Reserve through expert-guided safaris, offering rare
                  wildlife encounters, stunning landscapes, and unforgettable
            ...
            >
              <img
                src={`${import.meta.env.BASE_URL}packages/4in1safari.webp`}
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <ul className="text-gray-700">
                      <li>3 open gypsy safaris in Kuno National Park</li>
                      <li>2 open gypsy safaris in Madhav National Park</li>
                      <li>1 open gypsy Gharial safari</li>
                    </ul>
                  </li>
                  <li className="flex items-start">
